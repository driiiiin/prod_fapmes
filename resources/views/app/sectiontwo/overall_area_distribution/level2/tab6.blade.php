    ...
    <div class="card-body pt-0">
        <div class="row">
            <div class="col-md-9 pt-4">
                ...
                <!-- 1st data: Level 2- Total Budget -->
                <div class="bar-chart-container">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-left mb-0"><strong>Level 2 - Total Budget</strong></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    $labels[] = $level2->level2;
                                    $data[] = $level2->total_budget;
                                    }
                                    @endphp
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            const ctx = document.getElementById('level2Chart').getContext('2d');
                                            const level2Chart = new Chart(ctx, {
                                                type: 'bar',
                                                data: {
                                                    labels: @json($labels),
                                                    datasets: [{
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    foreach ($level2s as $level2) {
                                    $labels[] = $level2->level2;
                                    $totalBudget += $level2->total_budget;
                                    $data[] = [
                                    'label' => $level2->level2,
                                    'data' => $level2->total_budget,
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            const ctx2 = document.getElementById('level2Chart2').getContext('2d');
                                            const level2Chart2 = new Chart(ctx2, {
                                                type: 'doughnut',
                                                data: {
                                                    labels: @json($labels),
                                                    datasets: [{
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="level2-table" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    @forelse($level2s as $level2)
                                                    <tr>
                                                        <td>{{ $level2->level2 }}</td>
                                                        <td class="text-center">{{ $level2->project_count }}</td>
                                                    ...
                                                    <tr style="background-color: #f5f5f5;">
                                                        ...
                                                        <td class="text-center"><strong>{{ number_format(collect($level2s)->sum('project_count'), 0, '.', ',') }}</strong></td>
                                                        <td class="text-center"><strong>{{ number_format(collect($level2s)->sum('total_budget'), 2, '.', ',') }}</strong></td>
                                                        <td class="text-center"><strong>{{ number_format(collect($level2s)->sum('count_percentage'), 2, '.', ',') . '%' }}</strong></td>
                                                        <td class="text-center"><strong>{{ number_format(collect($level2s)->sum('budget_percentage'), 2, '.', ',') . '%' }}</strong></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
