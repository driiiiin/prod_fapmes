    ...
    <div class="card-body pt-0">
        <div class="row">
            <div class="col-md-9 pt-4">
                ...
                <div class="bar-chart-container">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-left mb-0"><strong>Funding Sources - Total Budget</strong></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    $fundsCode = DB::table('ref_funds')->where('funds_desc', $fundingsource->funding_source)->value('funds_code');
                                    if ($fundsCode) {
                                    $labels[] = $fundsCode;
                                    $data[] = $fundingsource->total_budget;
                                    }
                                    }
                                    @endphp
                ...
                <!-- 2nd data: Funding Sources - Total Budget -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if ($fundsCode) {
                                    $labels[] = $fundsCode;
                                    $totalBudget += $fundingsource->total_budget;
                                    $data[] = [
                                    'label' => $fundsCode,
                                    'data' => $fundingsource->total_budget,
                                    ...
                                    <div style="width: 400px; overflow-x: auto; margin: 0 auto;">
                                        <canvas id="fundingChart2"></canvas>
                                    </div>
                                    ...
                                    <script>
                                        const ctx2 = document.getElementById('fundingChart2').getContext('2d');
                                        const fundingChart2 = new Chart(ctx2, {
                                            type: 'doughnut',
                                            data: {
                                                labels: @json($labels),
                                                datasets: [{
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="fundingsource-table" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $fundingsource->funding_source }}</td>
                                                        <td class="text-center">{{ $fundingsource->project_count }}</td>
                                                        <td class="text-center">{{ number_format($fundingsource->total_budget, 2, '.', ',') }}</td>
                                                        <td class="text-center">{{ number_format($fundingsource->count_percentage, 2, '.', ',') . '%' }}</td>
                                                        <td class="text-center">{{ number_format($fundingsource->budget_percentage, 2, '.', ',') . '%' }}</td>
                                                    </tr>
                                                    @empty
                                                    <!-- <tr>
