<div class="tab-pane fade show active" id="depdev-classes" role="tabpanel" aria-labelledby="depdev-classes-tab">
    <div class="card-body pt-0">
        <div class="row">
            <div class="col-md-9 pt-4">

                <!-- 1st data: DEPdev- Total Budget -->
                <div class="bar-chart-container">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="text-left mb-0"><strong>DEPDev - Total Budget</strong></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    $labels[] = $depdev->depdev;
                                    $data[] = $depdev->total_budget;
                                    }
                                    @endphp

                                    <div style="width: 100%; overflow-x: auto;">
                                        <canvas id="depdevChart"></canvas>
                                    </div>
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            // Bar Chart
                                            const ctx = document.getElementById('depdevChart').getContext('2d');
                                            const labels = @json($labels);
                                            const data = @json($data);
                                            const depdevChart = new Chart(ctx, {
                                                type: 'bar',
                                                data: {
                                                    labels: labels,
                                                    datasets: [{
                ...
                <!-- 2nd data: depdev Classes - Total Budget (Doughnut) -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    foreach ($depdevs as $depdev) {
                                    $labels[] = $depdev->depdev;
                                    $totalBudget += $depdev->total_budget;
                                    $data[] = [
                                    'label' => $depdev->depdev,
                                    'data' => $depdev->total_budget,
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            const ctx2 = document.getElementById('depdevChart2').getContext('2d');
                                            const depdevChart2 = new Chart(ctx2, {
                                                type: 'doughnut',
                                                data: {
                                                    labels: @json($labels),
                                                    datasets: [{
                ...
                <!-- 3rd data: depdev Classes - Breakdown -->
                <div class="row pt-4">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered" id="depdev-table" style="width: 100%;">
                                                <thead style="border-top: 1px solid #ccc;">
                                                    <tr>
                                                        <th scope="col">DEPDev</th>
                                                ...
                                                <tbody>
                                                    @forelse($depdevs as $depdev)
                                                    <tr>
                                                        <td>{{ $depdev->depdev }}</td>
                                                        <td class="text-center">{{ $depdev->project_count }}</td>
                                                    ...
                                                    <tr style="background-color: #f5f5f5;">
                                                        ...
                                                        <td class="text-center">{{ number_format(collect($depdevs)->sum('project_count'), 0, '.', ',') }}</td>
                                                        <td class="text-center">{{ number_format(collect($depdevs)->sum('total_budget'), 2, '.', ',') }}</td>
                                                        <td class="text-center">{{ number_format(collect($depdevs)->sum('count_percentage'), 2, '.', ',') . '%' }}</td>
                                                        <td class="text-center">{{ number_format(collect($depdevs)->sum('budget_percentage'), 2, '.', ',') . '%' }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
